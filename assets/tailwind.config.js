...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Stone - Primary neutral palette (warm grays)
        stone: {
          50: '#fafaf9',
          100: '#f5f5f4',
          200: '#e7e5e4',
    ...
    typography: (theme) => ({
      ...
      DEFAULT: {
        css: {
          ...
          '--tw-prose-underline': theme('colors.amber.500 / 0.3'),
          ...
          '--tw-prose-invert-links-hover': theme('colors.amber.300'),
          ...
          '--tw-prose-invert-bullets': theme('colors.amber.400'),
          ...
          '--tw-prose-invert-pre-border': theme('colors.stone.700'),
