                ...
                >
                  <li class="group relative flex flex-col items-start">
                    ...
                    <h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                      ...
                      <a href="http://planetaria.tech">
                        ...
                        </span><span class="relative z-10">Planetaria</span>
                      </a>
                    </h2>
                  ...
                  <li class="group relative flex flex-col items-start">
                    ...
                    <h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                      ...
                      <a href="/projects#">
                        <span class="absolute -inset-y-6 -inset-x-4 z-20 sm:-inset-x-6 sm:rounded-2xl">
                        </span><span class="relative z-10">Animaginary</span>
                      </a>
                    </h2>
                    <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                  ...
                  <li class="group relative flex flex-col items-start">
                    ...
                    <h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                      ...
                      <a href="/projects#">
                        <span class="absolute -inset-y-6 -inset-x-4 z-20 sm:-inset-x-6 sm:rounded-2xl">
                        </span><span class="relative z-10">HelioStream</span>
                      </a>
                    </h2>
                    <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                  ...
                  <li class="group relative flex flex-col items-start">
                    ...
                    <h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                      ...
                      <a href="/projects#">
                        <span class="absolute -inset-y-6 -inset-x-4 z-20 sm:-inset-x-6 sm:rounded-2xl">
                        </span><span class="relative z-10">cosmOS</span>
                      </a>
                    </h2>
                    <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
                  ...
                  <li class="group relative flex flex-col items-start">
                    ...
                    <h2 class="mt-6 text-base font-semibold text-zinc-800 dark:text-zinc-100">
                      ...
                      <a href="/projects#">
                        <span class="absolute -inset-y-6 -inset-x-4 z-20 sm:-inset-x-6 sm:rounded-2xl">
                        </span><span class="relative z-10">OpenShuttle</span>
                      </a>
                    </h2>
                    <p class="relative z-10 mt-2 text-sm text-zinc-600 dark:text-zinc-400">
