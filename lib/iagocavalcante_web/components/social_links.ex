defmodule IagocavalcanteWeb.SocialLinks do
  ...
  def social_links(assigns) do
    class_link =
      if assigns.only_icon,
        do: "group -m-1 p-1 transition-colors duration-200 hover:text-accent",
        else:
          "group flex text-sm font-medium text-ink-light transition-colors duration-200 hover:text-accent"

    assigns = assign(assigns, :class_link, class_link)
  ...
  defp social_icon(%{social: "twitter"} = assigns) do
    ~H"""
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
      class="h-6 w-6 fill-current text-muted group-hover:text-accent transition-colors duration-200"
    >
  ...
  defp social_icon(%{social: "linkedin"} = assigns) do
    ~H"""
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
  ...
  defp social_icon(%{social: "github"} = assigns) do
    ~H"""
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
  ...
  defp social_icon(%{social: "instagram"} = assigns) do
    ~H"""
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
