  ...
  attr :events, :list,
    default: [
      %{
        ...
        description: "Internal presentation at Idopter Labs Talks, showcasing the latest updates on my favorite framework, Vue 3."
      },
      %{
        event: "DevOpsDays - Belém",
        title: "Starting with DevOps in personal projects",
        year: "2018",
        link: "https://docs.google.com/presentation/d/e/2PACX-1vTD2rAv41sGiTCyqlHw1ly_7g1FDqe_V3riCOLEpbcebcrYPsPdci4oRbj4RP6WYWN3Io445ujnl7z4/pub?start=false&loop=false&delayms=3000#slide=id.gcb9a0b074_1_0",
        description: "I see a lot of people wanting to start with DevOps or understand it better, but it can be difficult to practice in your work environment. So, nothing better than starting with something that is yours and that will probably cost you almost nothing. That is the main goal of this talk, to get out of inertia and get your hands dirty."
      }
    ]

  def events(assigns) do
    ~H"""
    <article class="group relative flex flex-col items-start" :for={event <- @events}>
      <h3 class="text-base font-semibold tracking-tight text-zinc-800 dark:text-zinc-100">
        ...
        <a href="/speaking#">
          ...
          </span><span class="relative z-10"><%= event.title %></span>
        </a>
      </h3>
      ...
      >
        <%= gettext "Link to presentation or video" %><svg
          viewBox="0 0 16 16"
          fill="none"
          aria-hidden="true"
