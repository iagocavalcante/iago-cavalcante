        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-muted font-mono">
              {length(bookmarks)} {if length(bookmarks) == 1,
                do: gettext("bookmark", lang: @locale),
                else: gettext("bookmarks", lang: @locale)}
            </p>
          </div>
        </div>
    ...
    <!-- Bookmarks Grid -->
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <article
            :for={
              bookmark <-
                get_visible_bookmarks(bookmarks, tag, @expanded_tags, @items_per_page, @show_all_view)
            }
            ...
            <div class="flex flex-col h-full">
              ...
              <div class="flex items-start justify-between gap-3">
                ...
                <div class="flex-shrink-0">
                  <svg
                    class="h-4 w-4 text-muted group-hover:text-accent transition-colors duration-200"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                    stroke-width="1.5"
    ...
    <!-- Tags & Date -->
              <div class="mt-auto pt-4 flex items-center justify-between">
                ...
                <time
                  ...
                  datetime={Bookmarks.format_date(bookmark.time_added)}
                >
          ...
          <div class="text-center">
            ...
            >
              {gettext("Show %{count} more",
                count: get_remaining_count(bookmarks, tag, @expanded_tags, @items_per_page),
                lang: @locale
              )}
            </button>
          </div>
