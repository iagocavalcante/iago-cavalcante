defmodule IagocavalcanteWeb.Components.CommentsTest do
  ...
  describe "handle_event submit_comment with honeypot" do
    test "rejects submission when honeypot field is filled" do
      ...
      assert updated_socket.assigns.message ==
  ...
  describe "handle_event submit_comment" do
    test "creates comment with valid data" do
      ...
      {:noreply, updated_socket} =
        Comments.handle_event("submit_comment", @valid_comment_attrs, socket)
      ...
      assert comment.content ==
               "This is a great post! Thank you for sharing your insights with us."
    ...
    test "shows success message for auto-approved comments" do
      ...
      attrs = %{
        ...
        "content" =>
          "This is a great post with good quality content that should be auto-approved."
      }
  ...
  describe "handle_event reply_to_comment" do
    test "sets reply_to in socket assigns" do
      ...
      {:noreply, updated_socket} =
        Comments.handle_event("reply_to_comment", %{"comment-id" => comment_id}, socket)
  ...
  describe "render/1" do
    test "renders comment form with proper fields" do
      {:ok, view, _html} =
        live_isolated(build_conn(), Comments, %{
          post_id: "dokploy-simplest-deployment-platform-vps-homelab"
        })
    ...
    test "renders success message when present" do
      socket =
        build_socket_with_post("dokploy-simplest-deployment-platform-vps-homelab",
    ...
    test "shows loading state on submit button" do
      socket =
        build_socket_with_post("dokploy-simplest-deployment-platform-vps-homelab", loading: true)
